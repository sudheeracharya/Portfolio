      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        <div className="space-y-8">
          ...
          >
            ...
            >
              <img 
                src="https://media.licdn.com/dms/image/v2/D5635AQH7jwfRap1vWQ/profile-framedphoto-shrink_400_400/B56ZjXcg8mIEAg-/0/1755961233531?e=1758315600&v=beta&t=4G5TTYd78_sXlxZcBzYLxKFqCC-lXog3tMKuyw0oY1M" 
                alt="Sudheer Kumar R"
          ...
          >
            <motion.button
              ...
              className="group bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white px-8 py-3 rounded-full transition-all duration-300 transform hover:scale-105 hover:shadow-xl hover:shadow-purple-500/25 flex items-center gap-2"
              whileHover={{ 
                scale: 1.05, 
